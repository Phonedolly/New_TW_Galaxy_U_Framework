...
.method public static updateMccMncConfiguration(Lcom/android/internal/telephony/PhoneBase;Ljava/lang/String;)V
    ...
    invoke-static {v7}, Ljava/lang/Integer;->parseInt(Ljava/lang/String;)I
    :try_end_1d
    .catch Ljava/lang/NumberFormatException; {:try_start_d .. :try_end_1d} :catch_e9
    ...
    const-string/jumbo v8, "updateMccMncConfiguration: mcc="
    ...
    .line 601
    const-string/jumbo v7, "ril.sim_language"
    ...
    .line 602
    .local v5, usimLang:Ljava/lang/String;
    invoke-virtual {p0}, Lcom/android/internal/telephony/PhoneBase;->getContext()Landroid/content/Context;
    ...
    const-string v7, "currentLocale is diffrent with usimLang. try to set new locale."
    ...
    .line 607
    .local v6, usimLangRegion:[Ljava/lang/String;
    ...
    iput-boolean v7, v0, Landroid/content/res/Configuration;->userSetLocale:Z
    ...
    :try_end_c9
    .catch Landroid/os/RemoteException; {:try_start_aa .. :try_end_c9} :catch_f3

    .line 620
    .end local v0           #config:Landroid/content/res/Configuration;
    .end local v6           #usimLangRegion:[Ljava/lang/String;
    :cond_c9
    :goto_c9
    if-eqz v3, :cond_d1

    .line 621
    invoke-static {p0, v3}, Lcom/android/internal/telephony/MccTable;->setTimezoneFromMccIfNeeded(Lcom/android/internal/telephony/PhoneBase;I)V

    .line 623
    invoke-static {p0, v3}, Lcom/android/internal/telephony/MccTable;->setWifiChannelsFromMcc(Lcom/android/internal/telephony/PhoneBase;I)V
    ...
    invoke-interface {v7, v0}, Landroid/app/IActivityManager;->updateConfiguration(Landroid/content/res/Configuration;)V
    :try_end_e8
    .catch Landroid/os/RemoteException; {:try_start_d1 .. :try_end_e8} :catch_fd
    ...
    .end local v3           #mcc:I
    .end local v4           #mnc:I
    .end local v5           #usimLang:Ljava/lang/String;
    :cond_e8
    :goto_e8
    return-void
    ...
    .restart local v5       #usimLang:Ljava/lang/String;
    .restart local v6       #usimLangRegion:[Ljava/lang/String;
    :catch_f3
    move-exception v7
