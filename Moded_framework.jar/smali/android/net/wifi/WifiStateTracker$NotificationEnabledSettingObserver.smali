...
.method private getValue()Z
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateTracker;->access$1800(Landroid/net/wifi/WifiStateTracker;)Landroid/content/Context;
...
.method public onChange(Z)V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/WifiStateTracker;->access$1602(Landroid/net/wifi/WifiStateTracker;Z)Z

    .line 2967
    iget-object v0, p0, Landroid/net/wifi/WifiStateTracker$NotificationEnabledSettingObserver;->this$0:Landroid/net/wifi/WifiStateTracker;

    #getter for: Landroid/net/wifi/WifiStateTracker;->mNotificationEnabled:Z
    invoke-static {v0}, Landroid/net/wifi/WifiStateTracker;->access$1600(Landroid/net/wifi/WifiStateTracker;)Z
    ...
    invoke-static {v0}, Landroid/net/wifi/WifiStateTracker;->access$1700(Landroid/net/wifi/WifiStateTracker;)V
...
.method public register()V
    ...
    #getter for: Landroid/net/NetworkStateTracker;->mContext:Landroid/content/Context;
    invoke-static {v1}, Landroid/net/wifi/WifiStateTracker;->access$1500(Landroid/net/wifi/WifiStateTracker;)Landroid/content/Context;
    ...
    #setter for: Landroid/net/wifi/WifiStateTracker;->mNotificationEnabled:Z
    invoke-static {v1, v2}, Landroid/net/wifi/WifiStateTracker;->access$1602(Landroid/net/wifi/WifiStateTracker;Z)Z
