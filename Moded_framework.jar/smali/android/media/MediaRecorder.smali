...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/media/MediaRecorder$OnCallbackListener;,
...
.field private static final MEDIARECORDER_CMD_TAKESNAPSHOT:I = 0x3ea
...
.field private mOnCallbackListener:Landroid/media/MediaRecorder$OnCallbackListener;
...
.method static synthetic access$300(Landroid/media/MediaRecorder;)Landroid/media/MediaRecorder$OnCallbackListener;
    .registers 2
    .parameter "x0"

    .prologue
    .line 64
    iget-object v0, p0, Landroid/media/MediaRecorder;->mOnCallbackListener:Landroid/media/MediaRecorder$OnCallbackListener;
...
.method public final native_takeLiveSnapshot()V
    .registers 3
    ...
    invoke-direct {p0, v0, v1, v1}, Landroid/media/MediaRecorder;->native_sendcommand(III)V
...
.method public setOnCallbackListener(Landroid/media/MediaRecorder$OnCallbackListener;)V
    .registers 2
    .parameter "listener"

    .prologue
    .line 750
    iput-object p1, p0, Landroid/media/MediaRecorder;->mOnCallbackListener:Landroid/media/MediaRecorder$OnCallbackListener;
...
.method public setOrientation(I)V
    ...
    :cond_e
    :try_start_e
    const-string/jumbo v0, "orientation=%d"
    ...
    invoke-direct {p0, v0}, Landroid/media/MediaRecorder;->setParameter(Ljava/lang/String;)V
    :try_end_22
    .catch Ljava/lang/IllegalStateException; {:try_start_e .. :try_end_22} :catch_3c
