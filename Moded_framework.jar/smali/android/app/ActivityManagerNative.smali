...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .prologue
    .line 127
    packed-switch p1, :pswitch_data_12fc
    ...
    .line 167
    .local v141, result:Landroid/app/IActivityManager$WaitResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v14           #onlyIfNeeded:Z
    .end local v15           #debug:Z
    .end local v141           #result:Landroid/app/IActivityManager$WaitResult;
    :cond_c9
    const/4 v5, 0x0
    ...
    .line 223
    .local v87, callingActivity:Landroid/os/IBinder;
    sget-object v5, Landroid/content/Intent;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 231
    .end local v7           #intent:Landroid/content/Intent;
    .end local v87           #callingActivity:Landroid/os/IBinder;
    .end local v141           #result:Z
    :pswitch_1d3
    const-string v5, "android.app.IActivityManager"
    ...
    .line 258
    .restart local v140       #res:Z
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 259
    if-eqz v140, :cond_259
    ...
    .line 272
    .local v135, rec:Landroid/content/IIntentReceiver;
    :goto_27a
    ...
    check-cast v99, Landroid/content/IntentFilter;

    .line 273
    .local v99, filter:Landroid/content/IntentFilter;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .end local v99           #filter:Landroid/content/IntentFilter;
    .end local v135           #rec:Landroid/content/IIntentReceiver;
    :cond_2ad
    const/4 v5, 0x0
    ...
    .restart local v99       #filter:Landroid/content/IntentFilter;
    .restart local v135       #rec:Landroid/content/IIntentReceiver;
    :cond_2b4
    const/4 v5, 0x0
    ...
    move-object/from16 v149, p1

    .line 387
    .local v149, thumbnail:Landroid/graphics/Bitmap;
    :goto_448
    ...
    check-cast v93, Ljava/lang/CharSequence;

    .line 388
    .local v93, description:Ljava/lang/CharSequence;
    move-object/from16 v0, p0
    ...
    .line 385
    .end local v93           #description:Ljava/lang/CharSequence;
    .end local v149           #thumbnail:Landroid/graphics/Bitmap;
    .restart local p1
    :cond_464
    const/4 v5, 0x0
    ...
    .line 405
    .local v140, res:Ljava/lang/String;
    :goto_499
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 404
    .end local v140           #res:Ljava/lang/String;
    :cond_4a6
    const/4 v5, 0x0
    ...
    .line 414
    .local v90, cn:Landroid/content/ComponentName;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 420
    .end local v46           #token:Landroid/os/IBinder;
    .end local v90           #cn:Landroid/content/ComponentName;
    :pswitch_4cb
    const-string v5, "android.app.IActivityManager"
    ...
    .line 424
    .local v137, receiverBinder:Landroid/os/IBinder;
    if-eqz v137, :cond_523

    invoke-static/range {v137 .. v137}, Landroid/app/IThumbnailReceiver$Stub;->asInterface(Landroid/os/IBinder;)Landroid/app/IThumbnailReceiver;
    ...
    .line 427
    .local v136, receiver:Landroid/app/IThumbnailReceiver;
    :goto_4e7
    move-object/from16 v0, p0
    ...
    .end local v136           #receiver:Landroid/app/IThumbnailReceiver;
    :cond_523
    const/4 v5, 0x0
    ...
    .restart local v136       #receiver:Landroid/app/IThumbnailReceiver;
    :cond_527
    const/4 v5, -0x1
    ...
    .end local v136           #receiver:Landroid/app/IThumbnailReceiver;
    .end local v137           #receiverBinder:Landroid/os/IBinder;
    :pswitch_52e
    const-string v5, "android.app.IActivityManager"
    ...
    .line 551
    .restart local v149       #thumbnail:Landroid/graphics/Bitmap;
    :goto_6e6
    sget-object v5, Landroid/text/TextUtils;->CHAR_SEQUENCE_CREATOR:Landroid/os/Parcelable$Creator;
    ...
    .line 552
    .restart local v93       #description:Ljava/lang/CharSequence;
    move-object/from16 v0, p0
    ...
    .line 563
    .local v92, cph:Landroid/app/IActivityManager$ContentProviderHolder;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v6           #app:Landroid/app/IApplicationThread;
    .end local v84           #b:Landroid/os/IBinder;
    .end local v92           #cph:Landroid/app/IActivityManager$ContentProviderHolder;
    ...
    .line 597
    .local v91, comp:Landroid/content/ComponentName;
    move-object/from16 v0, p0
    ...
    .line 604
    .end local v91           #comp:Landroid/content/ComponentName;
    ...
    .line 610
    .restart local v90       #cn:Landroid/content/ComponentName;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 731
    .local v142, results:Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .end local v32           #resultCode:I
    .end local v84           #b:Landroid/os/IBinder;
    .end local v142           #results:Landroid/os/Bundle;
    :pswitch_9ee
    const-string v5, "android.app.IActivityManager"
    ...
    .line 756
    .local v139, requestedOrientation:I
    move-object/from16 v0, p0
    ...
    .line 762
    .end local v46           #token:Landroid/os/IBinder;
    .end local v139           #requestedOrientation:I
    :pswitch_a48
    const-string v5, "android.app.IActivityManager"
    ...
    .line 801
    .local v140, res:Landroid/content/IIntentSender;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 802
    if-eqz v140, :cond_b05

    invoke-interface/range {v140 .. v140}, Landroid/content/IIntentSender;->asBinder()Landroid/os/IBinder;
    ...
    .end local v140           #res:Landroid/content/IIntentSender;
    .restart local p1
    :cond_b01
    const/4 v5, 0x0
    ...
    .restart local v140       #res:Landroid/content/IIntentSender;
    :cond_b05
    const/4 v5, 0x0
    ...
    .line 810
    .local v133, r:Landroid/content/IIntentSender;
    move-object/from16 v0, p0
    ...
    .line 816
    .end local v133           #r:Landroid/content/IIntentSender;
    :pswitch_b24
    const-string v5, "android.app.IActivityManager"
    ...
    .line 819
    .restart local v133       #r:Landroid/content/IIntentSender;
    move-object/from16 v0, p0
    ...
    .line 984
    .local v152, watcher:Landroid/app/IActivityController;
    move-object/from16 v0, p0
    ...
    .line 989
    .end local v152           #watcher:Landroid/app/IActivityController;
    :pswitch_dcf
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1028
    .local v89, cls:Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 1030
    .local v101, indata:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v89           #cls:Ljava/lang/String;
    .end local v101           #indata:Ljava/lang/String;
    ...
    new-instance v88, Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    .line 1039
    .local v88, ci:Landroid/app/ApplicationErrorReport$CrashInfo;
    move-object/from16 v0, p0
    ...
    .end local v88           #ci:Landroid/app/ApplicationErrorReport$CrashInfo;
    :pswitch_e98
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1048
    .local v147, tag:Ljava/lang/String;
    new-instance v88, Landroid/app/ApplicationErrorReport$CrashInfo;
    ...
    .line 1049
    .restart local v88       #ci:Landroid/app/ApplicationErrorReport$CrashInfo;
    move-object/from16 v0, p0
    ...
    .end local v88           #ci:Landroid/app/ApplicationErrorReport$CrashInfo;
    .end local v140           #res:Z
    .end local v147           #tag:Ljava/lang/String;
    :pswitch_ecd
    const-string v5, "android.app.IActivityManager"
    ...
    .end local v150           #violationMask:I
    :pswitch_ef6
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1104
    .local v98, fd:Landroid/os/ParcelFileDescriptor;
    :goto_f81
    move-object/from16 v0, p0
    ...
    .line 1100
    .end local v98           #fd:Landroid/os/ParcelFileDescriptor;
    .end local v121           #path:Ljava/lang/String;
    .end local v140           #res:Z
    .end local v144           #start:Z
    :cond_f9e
    const/4 v5, 0x0
    ...
    .line 1106
    .restart local v98       #fd:Landroid/os/ParcelFileDescriptor;
    .restart local v140       #res:Z
    :cond_fa6
    const/4 v5, 0x0
    ...
    .line 1147
    .local v146, success:Z
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V

    .line 1148
    if-eqz v146, :cond_104b
    ...
    .line 1173
    .local v152, watcher:Landroid/app/IActivityWatcher;
    move-object/from16 v0, p0
    ...
    .line 1178
    .end local v152           #watcher:Landroid/app/IActivityWatcher;
    :pswitch_10a6
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1181
    .restart local v152       #watcher:Landroid/app/IActivityWatcher;
    move-object/from16 v0, p0
    ...
    .line 1226
    .local v82, appname:Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/app/ActivityManagerNative;->startApplication(Landroid/content/Intent;ILjava/lang/String;)V
    ...
    .end local v7           #intent:Landroid/content/Intent;
    .end local v78           #mode:I
    .end local v82           #appname:Ljava/lang/String;
    :pswitch_1174
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1233
    .restart local v82       #appname:Ljava/lang/String;
    move-object/from16 v0, p0

    move-object/from16 v1, v82

    invoke-virtual {v0, v1}, Landroid/app/ActivityManagerNative;->stopApplication(Ljava/lang/String;)V
    ...
    .line 1243
    .local v140, res:[Landroid/os/Debug$MemoryInfo;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1249
    .end local v126           #pids:[I
    .end local v140           #res:[Landroid/os/Debug$MemoryInfo;
    :pswitch_11b0
    const-string v5, "android.app.IActivityManager"
    ...
    .line 1262
    .local v96, enterAnim:I
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I

    move-result v97

    .line 1263
    .local v97, exitAnim:I
    move-object/from16 v0, p0
    ...
    .end local v46           #token:Landroid/os/IBinder;
    .end local v65           #packageName:Ljava/lang/String;
    .end local v96           #enterAnim:I
    .end local v97           #exitAnim:I
    :pswitch_11fa
    const-string v5, "android.app.IActivityManager"
